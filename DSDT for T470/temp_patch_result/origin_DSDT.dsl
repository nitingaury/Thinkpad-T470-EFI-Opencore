 ...
 *
 * Disassembly of DSDT.aml, Mon Aug 29 14:59:19 2022
 *
...
DefinitionBlock ("", "DSDT", 2, "LENOVO", "SKL     ", 0x00000000)
{
    ...
    Name (SS3, 0x01)
    Name (SS4, 0x01)
    OperationRegion (GNVS, SystemMemory, 0xAFF58000, 0x072C)
    ...
    OperationRegion (MNVS, SystemMemory, 0xAFF68018, 0x1000)
